...
<ResponseField name="event" type="object">
  ...
  [Payin Source](/api-documentation/payinSource/object) , [Payin
  Request]((/api-documentation/payinRequest/object)) , [Payout
  Target](/api-documentation/payoutTarget/object) , [Payout
  Request](/api-documentation/payoutRequest/object)
</ResponseField>
