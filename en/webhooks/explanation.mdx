...
<ResponseField name="status" type="string">
  One of `pending`, `ready`, `paid`, `cancelled`, or `chargeback`.
</ResponseField>
...
<ResponseField name="settlementDate" type="string">
  Settlement date. Present once the invoice is settled.
</ResponseField>
<ResponseField name="settlementTime" type="string">
  Settlement cycle. Present once the invoice is settled.
</ResponseField>
